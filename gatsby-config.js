...
module.exports = {
  siteMetadata: {
    title: `Blue Mountain Best`,
    description: `Description. Change me.`,
    author: `Alexander Fountain`,
    siteUrl: `https://www.bluemountainbest.com`,
  },
  plugins: [
    `gatsby-plugin-react-helmet`,
    {
      ...
      options: {
        ...
        sitemap: "https://www.bluemountainbest.com/sitemap.xml",
    ...
    `gatsby-plugin-netlify-headers`,
    {
      ...
      options: {
        name: `Blue Mountain Best`,
        short_name: `Blue Mountain Best`,
        start_url: `/`,
